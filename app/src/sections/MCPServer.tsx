        ...
        <div className="relative w-full h-full flex flex-col lg:flex-row items-center justify-center gap-6">
          ...
          >
            ...
            <p className="text-text-secondary text-base lg:text-lg leading-relaxed mb-8">
              Let AI assistants like Claude, Cursor, and Cline manage your mobile 
              proxy infrastructure through natural language.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-text-secondary">Works with Claude, Cursor, Cline</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-teal/10 flex items-center justify-center">
                  <span className="text-teal text-xs font-bold">USDC</span>
                </div>
                <span className="text-text-secondary">Crypto & Card Payments</span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 pb-4 border-b border-white/5 mb-4">
              ...
              <span className="ml-auto text-xs text-text-secondary">Online</span>
            </div>
                        ...
                        <div className="space-y-2 text-xs">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <code className="text-cyan">{message.details.http}</code>
                              <button
                                type="button"
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <code className="text-cyan">{message.details.socks5}</code>
                              <button
                                type="button"
                                aria-label="Copy SOCKS5 endpoint"
                                onClick={() => {
                                  void handleCopy(message.details.socks5, 'socks5');
                                }}
                                className="text-text-secondary hover:text-cyan transition-colors"
                              >
                                {copied === 'socks5' ? (
            ...
            <div className="mt-4 pt-4 border-t border-white/5">
              <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-bg-primary/50 border border-white/5">
                <span className="text-text-secondary text-sm">Type a command...</span>
              </div>
            </div>
          </div>
        </div>
