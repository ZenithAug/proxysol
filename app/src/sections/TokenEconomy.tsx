          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {tokenMetrics.map((metric, index) => {
                ...
                const colorClass = 
                  metric.color === 'cyan' ? 'text-cyan bg-cyan/10' : 
                  metric.color === 'purple' ? 'text-purple bg-purple/10' : 
                  'text-teal bg-teal/10';

                return (
                  <div key={index} className="text-center p-4 rounded-xl bg-bg-primary/50 border border-white/5">
