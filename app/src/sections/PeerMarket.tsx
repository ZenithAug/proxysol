        ...
        <div className="relative w-full h-full flex flex-col lg:flex-row items-center justify-center gap-6">
          ...
          >
            ...
            <p className="text-text-secondary text-base lg:text-lg leading-relaxed mb-8">
              Run a proxy agent on your devices and earn USDC automatically. 
              Our network pays $0.02-0.25/GB for shared bandwidth.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-text-secondary">Instant USDC Payouts</span>
              </div>
              <div className="flex items-center gap-3">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className={`text-lg font-display font-bold ${colorClass.split(' ')[0]}`}>
                          {tier.price}
                        </p>
                        <p className="text-text-secondary text-xs">{tier.unit}</p>
                      </div>
                    </div>
                  );
                })}
